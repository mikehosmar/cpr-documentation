...
| Object Size (Horizontal) | Standard Sensor Kit                                            |
|--------------------------|----------------------------------------------------------------|
| Less than 0.6 cm         | No reliable detection                                          |
| 0.6 to 1.0 cm            | No reliable detection                                          |
| 1.0 to 3.0 cm            | 1.75 m                                                         |
| Greater than 3.0 cm      | Maximum collision avoidance distance (UGV-specific; see above) |
