...
## Supported Jazzy Platforms {#supported-platforms}

| Platform  | Platform code | Supports ROS 2 Jazzy (amd64)  | (arm64) |
| :-------- | :------------ | :---------------------------- | :------ |
| Husky     | A200          | Yes (As of 2.0)               | Coming  |
|           | A300          | Yes (As of 2.0)               | Coming  |
| Jackal    | J100          | Coming                        | Coming  |
| Warthog   | W200          | Coming                        | Coming  |
