...
Corner lighting is unified for platforms that support it (D100, D150, R100, W200). Lighting is controlled by the [lighting node](https://github.com/clearpathrobotics/clearpath_common/tree/jazzy/clearpath_platform/src/lighting) which defines multiple lighting states.
