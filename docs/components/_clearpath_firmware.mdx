...
:::note
  ...
  If you are updating to ROS 2 Jazzy for the first time, you must use USB. If you are updating ROS 2 Jazzy firmware
...
| Husky A300          | Ethernet        |
| Jackal J100         | USB             |
| Warthog W200        | USB or Ethernet |
| Ridgeback R100      | USB or Ethernet |
| Dingo DD100 / DO100 | USB or Ethernet |
| Dingo DD150 / DO150 | USB or Ethernet |
